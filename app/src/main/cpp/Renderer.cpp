...
GrassRenderer::~GrassRenderer() {
    // We intentionally do not call glDelete here. 
...
void GrassRenderer::render(int width, int height) {
    ...
    if (grassComputeProgram != 0) {
        ...
        glUniform3f(glGetUniformLocation(grassComputeProgram, "u_CamForward"), camForwardX, camForwardY, camForwardZ);
    ...
    if (grassProgram != 0) {
        ...
        // Render from SSBO
        // glDrawArraysInstanced(GL_TRIANGLE_STRIP, 0, 15, 65536);
    }
}
