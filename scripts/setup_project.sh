...
# --- Generate CMakeLists.txt (THE FIX) ---
cat << 'EOF' > app/src/main/cpp/CMakeLists.txt
cmake_minimum_required(VERSION 3.22.1)
project("procedural_engine")

# Define the C++ engine file generated by your other script
add_library(procedural_engine SHARED engine.cpp)

# Find Android native libraries for OpenGL ES 3 and Logging
