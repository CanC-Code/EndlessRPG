...
def bake_and_export(name, r, g, b, build_func, outfile, is_terrain=False):
    ...
    # REALISTIC AESTHETIC: Smooth Shading
    ...
    for tri in mesh.loop_triangles:
        for loop_idx in tri.loops:
            ...
            # Smooth lighting using Vertex Normals
            norm = v.normal
...
def build_tree():
    ...
    # FIXED: Used correct Blender 4.0 API call 'primitive_ico_sphere_add'
    ...
    bpy.ops.mesh.primitive_ico_sphere_add(subdivisions=2, radius=0.6, location=(0,0,3.4))
